...
_InvVpidContext		Proc	
	
	;invtype = 1 刷新除了VPID=0以外的所有VPID
	push	eax
        mov	eax, 1
        push	0
        push	0
...
_WriteProtectedOpen 	Endp

_WriteProtectedClose	Proc
...
_WriteProtectedClose 	Endp

_AttachGuestProcess	Proc
	local OldCr3:dword
...
_AttachGuestProcess 	Endp

_DetachTargetProcess	Proc	uses ebx esi edi OldCr3:dword
	
	mov 	eax, OldCr3
	mov 	cr3, eax
	ret
	
_DetachTargetProcess 	Endp
...
_GetIdtLimit	Endp
;===========================================================================
; 这个函数看着有点奇怪, 如果开启VT成功. 这个函数不会再返回
; 这个函数和_GuestEntryPoint配合实现堆栈平衡.
;===========================================================================
